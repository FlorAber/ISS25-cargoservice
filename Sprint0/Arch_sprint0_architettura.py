...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     with Cluster('ctx_cargo', graph_attr=nodeattr):
          cargo=Custom('cargo','./qakicons/symActorWithobjSmall.png')
     ...
     with Cluster('ctx_watcher', graph_attr=nodeattr):
          watcher=Custom('watcher','./qakicons/symActorWithobjSmall.png')
diag
