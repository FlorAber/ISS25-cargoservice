...
$(function () {
  $("#h").click(function () {
    callServerUsingAjax("h");
  });
  $("#w").click(function () {
    callServerUsingAjax("w");
  });
  $("#s").click(function () {
    callServerUsingAjax("s");
  });
  $("#r").click(function () {
    callServerUsingAjax("r");
  });
  $("#l").click(function () {
    callServerUsingAjax("l");
  });
  $("#p").click(function () {
    callServerUsingAjax("p");
  });
...
function callDoPlanUsingAjax() {
  ...
  $.ajax({
    ...
    success: function (msg) {
      //msg ha tutta la pagina ...
      //console.log("call msg="+msg);
      setMessageToWindow(
        infoDisplay,
        "callServerUsingAjax | " + planTodo + " done"
      );
    },
    error: function () {
...
function callServerUsingAjax(message) {
  $.ajax({
    ...
    success: function (msg) {
      ...
      setMessageToWindow(
        infoDisplay,
        "callServerUsingAjax | " + message + " done"
      );
    },
    error: function () {
      alert("Chiamata fallita, si prega di riprovare...");
